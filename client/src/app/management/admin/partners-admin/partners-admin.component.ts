...
export class PartnersAdminComponent implements OnInit {
  ...
  updatePartner() {
    ...
    this.http.post('http://127.0.0.1:8000/api/partner/update-info' + '/' + this.viewPartnerID, formData).subscribe((resultData: any) => {
      console.log(resultData);
  ...
  addPartner() {
    ...
    partnerData.append("company_name", this.form.controls['company_name'].value);
    if(this.company_logo){
      partnerData.append("logo", this.company_logo, this.company_logo.name);
    }
    ...
    this.http.post('http://127.0.0.1:8000/api/partner/add', partnerData).subscribe((resultData: any) => {
      console.log(resultData);
  ...
  getMoaFiles() {
    this.http.get('http://127.0.0.1:8000/api/partner/get-moa-files' + '/' + this.partnerID).subscribe(
      (response: any) => {
        this.moa = response;
  ...
  //   this.http.get('http://127.0.0.1:8000/api/partner/get-partner' + '/' + this.infoID).subscribe(
  //     (response: any) => {
  //       this.infos = response;
  //       console.log(response);
  //     },
